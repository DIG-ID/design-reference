...
### Fixed
- Export modal now wraps long lines instead of cutting them off with a horizontal scrollbar — prose exports (client brief, Markdown reports) are now readable in full.
